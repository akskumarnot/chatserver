...
const QMetaObjectExtraData mytask::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mytask::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mytask,
      qt_meta_data_mytask, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &mytask::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mytask))
