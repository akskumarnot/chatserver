...
const QMetaObjectExtraData people::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject people::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_people,
      qt_meta_data_people, &staticMetaObjectExtraData }
};
